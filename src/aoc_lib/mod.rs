...
pub fn get_day(day: u32) -> (Option<DayFn>, Option<DayFn>) {
    return match day {
        ...
        22 => (Some(days::day22::part1), Some(days::day22::part2)),
        23 => (
            Some(days::day23::basic::part1),
            Some(days::day23::complex::part2),
        ),
        24 => (Some(days::day24::only_part), None),
        25 => (Some(days::day25::part1), None),
        _ => {
